 ...
 * @Author: alec
 * Description:
 * @date: 12:11 2020-12-02
 */
public class Constants {

    public static final String TOPIC_DEVICE_REGISTER = "topic_device_register";

    public static final String TOPIC_DEVICE_CHANNEL_REGISTER = "topic_device_channel_register";
